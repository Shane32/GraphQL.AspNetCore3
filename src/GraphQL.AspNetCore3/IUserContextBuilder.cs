...
public interface IUserContextBuilder
{
    ...
    /// an object that has not fully been deserialized yet; when using the Newtonsoft.Json deserializer,
    /// this will be a JObject, and when using System.Text.Json this will be a JsonElement.  You may call
