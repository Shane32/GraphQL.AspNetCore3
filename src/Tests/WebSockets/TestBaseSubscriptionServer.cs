...
{
    public TestBaseSubscriptionServer(IWebSocketConnection sendStream, GraphQLHttpMiddlewareOptions options, IWebSocketAuthenticationService? authorizationService = null)
